  ...
  return (
    <div className="space-y-4 text-sm leading-relaxed text-muted-foreground">
      ...
      <p>
        ...
        <strong>{organisationName}</strong> (&ldquo;the Contributing Development Partner&rdquo;).
      </p>
      ...
      <section>
        ...
        <p>
          ...
          By registering, the Contributing Development Partner agrees to these terms for every dataset it submits, unless
      ...
      <section>
        ...
        <p>
          By submitting data to the Portal (&ldquo;Contributed Data&rdquo;), the Contributing Development Partner grants
        ...
        <p className="mt-2">
          ...
          Contributed Data is not transferred and remains with the Contributing Development Partner, subject to Section 3.
        </p>
      </section>

      <section>
        <h5 className="font-medium text-foreground mb-1">3. Representations and Warranties</h5>
        <p>The Contributing Development Partner represents and warrants that it:</p>
      ...
      <section>
        ...
        <p>
          ...
          Development Partner and to NSPHCDA administrators). The Contributing Development Partner is responsible for selecting a
      ...
      <section>
        ...
        <p>
          ...
          Contributing Development Partner&rsquo;s consent, where required by law, or where necessary to protect public
      ...
      <section>
        ...
        <p>
          The Contributing Development Partner retains all intellectual property rights in its Contributed Data, subject
          to the licence in Section 2. NSPHCDA will, where reasonably practicable, credit the Contributing
          Development Partner as a data source in any derivative work or publication, and will honour any data licence
          the Contributing Development Partner specifies for onward use by third parties.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          The Contributing Development Partner may request removal of its data from public access at any time. NSPHCDA
      ...
      <section>
        ...
        <p>
          ...
          Data within the Contributed Data. The Contributing Development Partner acts as data controller for any such data
      ...
      <section>
        ...
        <p>
          The Contributing Development Partner will indemnify NSPHCDA against claims arising from a breach of its
